Tasks 0. Read file Write a function that reads a text file (UTF8) and prints it to stdout:
...
10Student to JSON with filter Write a class Student that defines a student by: (based on 9-student.py)
